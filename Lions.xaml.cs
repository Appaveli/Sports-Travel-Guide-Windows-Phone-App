...
{
    public partial class Lions : PhoneApplicationPage
    {
        public Lions()
        {
            InitializeComponent();
        ...
        {
            MyMap.Center = new GeoCoordinate(42.3400, -83.0456);
            MyMap.ZoomLevel = 17;
        ...
        private void HyperlinkButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            LabeledMapLocation spaceNeedleLML = new LabeledMapLocation("Ford Field", null);
