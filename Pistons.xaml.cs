...
{
    public partial class Pistons : PhoneApplicationPage
    {
        public Pistons()
        {
            InitializeComponent();
        ...
        {
            MyMap.Center = new GeoCoordinate(42.6969, -83.2456);
            MyMap.ZoomLevel = 17;
        ...
        private void HyperlinkButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            LabeledMapLocation spaceNeedleLML = new LabeledMapLocation("The Palace of Auburn Hills", null);
