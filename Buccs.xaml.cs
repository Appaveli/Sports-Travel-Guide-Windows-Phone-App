...
{
    public partial class Buccs : PhoneApplicationPage
    {
        public Buccs()
        {
            InitializeComponent();
        ...
        {
            MyMap.Center = new GeoCoordinate(27.9758, -82.5033);
            MyMap.ZoomLevel = 17;
        ...
        private void HyperlinkButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            LabeledMapLocation spaceNeedleLML = new LabeledMapLocation("Raymond James Stadium", null);
