...
{
    public partial class Pacers : PhoneApplicationPage
    {
        public Pacers()
        {
            InitializeComponent();
        ...
        {
            MyMap.Center = new GeoCoordinate(39.763889, -86.155556);
            MyMap.ZoomLevel = 17;
        ...
        private void HyperlinkButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            LabeledMapLocation spaceNeedleLML = new LabeledMapLocation("Bankers Life Fieldhouse", null);
