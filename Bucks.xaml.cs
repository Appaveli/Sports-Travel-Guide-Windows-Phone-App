...
{
    public partial class Bucks : PhoneApplicationPage
    {
        public Bucks()
        {
            InitializeComponent();
        ...
        {
            MyMap.Center = new GeoCoordinate(43.0436, -87.9169);
            MyMap.ZoomLevel = 17;
        ...
        private void HyperlinkButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            LabeledMapLocation spaceNeedleLML = new LabeledMapLocation("BMO Harris Bradley Center", null);
