...
{
    public partial class Packers : PhoneApplicationPage
    {
        public Packers()
        {
            InitializeComponent();
        ...
        {
            MyMap.Center = new GeoCoordinate(44.5010, -88.0620);
            MyMap.ZoomLevel = 17;
        ...
        private void HyperlinkButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            LabeledMapLocation spaceNeedleLML = new LabeledMapLocation("Lambeau Field Stadium", null);
