...
{
    public partial class Falcons : PhoneApplicationPage
    {
        public Falcons()
        {
            InitializeComponent();
        ...
        {
            MyMap.Center = new GeoCoordinate(33.7575, -84.4008);
            MyMap.ZoomLevel = 17;
        ...
        private void HyperlinkButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            LabeledMapLocation spaceNeedleLML = new LabeledMapLocation("Georgia Dome", null);
