...
{
    public partial class Heat : PhoneApplicationPage
    {
        public Heat()
        {
            InitializeComponent();
        ...
        {
            MyMap.Center = new GeoCoordinate(25.7814, -80.1881);
            MyMap.ZoomLevel = 17;
        ...
        private void HyperlinkButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            LabeledMapLocation spaceNeedleLML = new LabeledMapLocation("American Airlines Arena", null);
