...
{
    public partial class Niners : PhoneApplicationPage
    {
        public Niners()
        {
            InitializeComponent();
        ...
        {
            MyMap.Center = new GeoCoordinate(37.4030, -121.9700);
            MyMap.ZoomLevel = 17;
        ...
        private void HyperlinkButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            LabeledMapLocation spaceNeedleLML = new LabeledMapLocation("Levi's Stadium", null);
