...
{
    public partial class Suns : PhoneApplicationPage
    {
        public Suns()
        {
            InitializeComponent();
        ...
        {
            MyMap.Center = new GeoCoordinate(33.4458, -112.0714);
            MyMap.ZoomLevel = 17;
        ...
        private void HyperlinkButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            LabeledMapLocation spaceNeedleLML = new LabeledMapLocation("US Airways Center", null);
