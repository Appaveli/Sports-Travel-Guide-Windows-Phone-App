...
{
    public partial class Steelers : PhoneApplicationPage
    {
        public Steelers()
        {
            InitializeComponent();
        ...
        {
            MyMap.Center = new GeoCoordinate(40.4467, -80.0158);
            MyMap.ZoomLevel = 17;
        ...
        private void HyperlinkButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            LabeledMapLocation spaceNeedleLML = new LabeledMapLocation("Heinz Field", null);
