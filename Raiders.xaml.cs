...
{
    public partial class Raiders : PhoneApplicationPage
    {
        public Raiders()
        {
            InitializeComponent();
        ...
        {
            MyMap.Center = new GeoCoordinate(37.7517, -122.2006);
            MyMap.ZoomLevel = 17;
        ...
        private void HyperlinkButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            LabeledMapLocation spaceNeedleLML = new LabeledMapLocation("Oakland–Alameda County Coliseum", null);
