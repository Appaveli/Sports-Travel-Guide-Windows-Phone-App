...
{
    public partial class Jaguars : PhoneApplicationPage
    {
        public Jaguars()
        {
            InitializeComponent();
        ...
        {
            MyMap.Center = new GeoCoordinate(30.3239, -81.6375);
            MyMap.ZoomLevel = 17;
        ...
        private void HyperlinkButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            LabeledMapLocation spaceNeedleLML = new LabeledMapLocation("EverBank Field", null);
