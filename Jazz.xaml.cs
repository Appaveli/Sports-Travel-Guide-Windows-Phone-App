...
{
    public partial class Jazz : PhoneApplicationPage
    {
        public Jazz()
        {
            InitializeComponent();
        ...
        {
            MyMap.Center = new GeoCoordinate(40.768333, -111.901111);
            MyMap.ZoomLevel = 17;
        ...
        private void HyperlinkButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            LabeledMapLocation spaceNeedleLML = new LabeledMapLocation("EnergySolutions Arena", null);
