...
{
    public partial class Bengals : PhoneApplicationPage
    {
        public Bengals()
        {
            InitializeComponent();
        ...
        {
            MyMap.Center = new GeoCoordinate(39.0954, -84.5160);
            MyMap.ZoomLevel = 17;
        ...
        private void HyperlinkButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            LabeledMapLocation spaceNeedleLML = new LabeledMapLocation("Paul Brown Stadium", null);
