...
{
    public partial class Magic : PhoneApplicationPage
    {
        public Magic()
        {
            InitializeComponent();
        ...
        {
            MyMap.Center = new GeoCoordinate(28.5392, -81.3836);
            MyMap.ZoomLevel = 17;
        ...
        private void HyperlinkButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            LabeledMapLocation spaceNeedleLML = new LabeledMapLocation("Amway Center", null);
