...
{
    public partial class Hawks : PhoneApplicationPage
    {
        public Hawks()
        {
            InitializeComponent();
        ...
        {
            MyMap.Center = new GeoCoordinate(33.7572, -84.3964);
            MyMap.ZoomLevel = 17;
        ...
        private void HyperlinkButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            LabeledMapLocation spaceNeedleLML = new LabeledMapLocation("Philips Arenar", null);
