...
{
    public partial class Dolphins : PhoneApplicationPage
    {
        public Dolphins()
        {
            InitializeComponent();
        ...
        {
            MyMap.Center = new GeoCoordinate(25.9581, -80.2389);
            MyMap.ZoomLevel = 17;
        ...
        private void HyperlinkButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            LabeledMapLocation spaceNeedleLML = new LabeledMapLocation("Sun Life Stadium", null);
