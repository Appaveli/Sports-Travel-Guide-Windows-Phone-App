...
{
    public partial class Cavaliers : PhoneApplicationPage
    {
        public Cavaliers()
        {
            InitializeComponent();
        ...
        {
            MyMap.Center = new GeoCoordinate(41.4964, -81.6881);
            MyMap.ZoomLevel = 17;
        ...
        private void HyperlinkButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            LabeledMapLocation spaceNeedleLML = new LabeledMapLocation("Quicken Loans Arena", null);
