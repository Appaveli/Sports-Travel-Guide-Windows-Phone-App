...
{
    public partial class Patriots : PhoneApplicationPage
    {
        public Patriots()
        {
            InitializeComponent();
        ...
        {
            MyMap.Center = new GeoCoordinate(42.0909, -71.2643);
            MyMap.ZoomLevel = 17;
        ...
        private void HyperlinkButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            LabeledMapLocation spaceNeedleLML = new LabeledMapLocation("Gillette Stadium", null);
