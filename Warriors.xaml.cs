...
{
    public partial class Warriors : PhoneApplicationPage
    {
        public Warriors()
        {
            InitializeComponent();
        ...
        {
            MyMap.Center = new GeoCoordinate(37.7503, -122.2031);
            MyMap.ZoomLevel = 17;
        ...
        private void HyperlinkButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            LabeledMapLocation spaceNeedleLML = new LabeledMapLocation("Oracle Arena", null);
