...
{
    public partial class Chargers : PhoneApplicationPage
    {
        public Chargers()
        {
            InitializeComponent();
        ...
        {
            MyMap.Center = new GeoCoordinate(32.7831, -117.1194);
            MyMap.ZoomLevel = 17;
        ...
        private void HyperlinkButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            LabeledMapLocation spaceNeedleLML = new LabeledMapLocation("Qualcomm Stadium", null);
