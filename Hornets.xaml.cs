...
{
    public partial class Hornets : PhoneApplicationPage
    {
        public Hornets()
        {
            InitializeComponent();
        ...
        {
            MyMap.Center = new GeoCoordinate(35.2250, -80.8392);
            MyMap.ZoomLevel = 17;
        ...
        private void HyperlinkButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            LabeledMapLocation spaceNeedleLML = new LabeledMapLocation("Time Warner Cable Arena", null);
