...
{
    public partial class Colts : PhoneApplicationPage
    {
        public Colts()
        {
            InitializeComponent();
        ...
        {
            MyMap.Center = new GeoCoordinate(39.7601, -86.1638);
            MyMap.ZoomLevel = 17;
        ...
        private void HyperlinkButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            LabeledMapLocation spaceNeedleLML = new LabeledMapLocation("Lucas Oil Stadium", null);
