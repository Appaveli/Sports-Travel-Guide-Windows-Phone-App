...
{
    public partial class Nets : PhoneApplicationPage
    {
        public Nets()
        {
            InitializeComponent();
        ...
        {
            MyMap.Center = new GeoCoordinate(40.6826, -73.9747);
            MyMap.ZoomLevel = 17;
        ...
        private void HyperlinkButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            LabeledMapLocation spaceNeedleLML = new LabeledMapLocation("Barclays Center", null);
