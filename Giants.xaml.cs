...
{
    public partial class Giants : PhoneApplicationPage
    {
        public Giants()
        {
            InitializeComponent();
        ...
        {
            MyMap.Center = new GeoCoordinate(40.8136, -74.0744);
            MyMap.ZoomLevel = 17;
        ...
        private void HyperlinkButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            LabeledMapLocation spaceNeedleLML = new LabeledMapLocation("MetLife Stadium", null);
