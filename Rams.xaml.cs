...
{
    public partial class Rams : PhoneApplicationPage
    {
        public Rams()
        {
            InitializeComponent();
        ...
        {
            MyMap.Center = new GeoCoordinate(38.6328, -90.1886);
            MyMap.ZoomLevel = 17;
        ...
        private void HyperlinkButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            LabeledMapLocation spaceNeedleLML = new LabeledMapLocation("Edward Jones Dome", null);
