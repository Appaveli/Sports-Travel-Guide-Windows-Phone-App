...
{
    public partial class Panthers : PhoneApplicationPage
    {
        public Panthers()
        {
            InitializeComponent();
        ...
        {
            MyMap.Center = new GeoCoordinate(35.2258, -80.8528);
            MyMap.ZoomLevel = 17;
        ...
        private void HyperlinkButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            LabeledMapLocation spaceNeedleLML = new LabeledMapLocation("Bank of America Stadium", null);
