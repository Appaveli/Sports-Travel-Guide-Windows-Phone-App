...
{
    public partial class Texans : PhoneApplicationPage
    {
        public Texans()
        {
            InitializeComponent();
        ...
        {
            MyMap.Center = new GeoCoordinate(29.6847, -95.4108);
            MyMap.ZoomLevel = 17;
        ...
        private void HyperlinkButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            LabeledMapLocation spaceNeedleLML = new LabeledMapLocation("NRG Stadium", null);
