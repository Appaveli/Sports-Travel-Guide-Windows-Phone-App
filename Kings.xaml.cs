...
{
    public partial class Kings : PhoneApplicationPage
    {
        public Kings()
        {
            InitializeComponent();
        ...
        {
            MyMap.Center = new GeoCoordinate(38.6492, -121.5181);
            MyMap.ZoomLevel = 17;
        ...
        private void HyperlinkButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            LabeledMapLocation spaceNeedleLML = new LabeledMapLocation("Sleep Train Arena", null);
