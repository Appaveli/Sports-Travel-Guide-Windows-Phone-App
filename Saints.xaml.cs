...
{
    public partial class Saints : PhoneApplicationPage
    {
        public Saints()
        {
            InitializeComponent();
        ...
        {
            MyMap.Center = new GeoCoordinate(29.9508, -90.0811);
            MyMap.ZoomLevel = 17;
        ...
        private void HyperlinkButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            LabeledMapLocation spaceNeedleLML = new LabeledMapLocation("Mercedes-Benz Superdome", null);
