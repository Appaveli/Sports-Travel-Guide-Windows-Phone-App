...
{
    public partial class Timberwolves : PhoneApplicationPage
    {
        public Timberwolves()
        {
            InitializeComponent();
        ...
        {
            MyMap.Center = new GeoCoordinate(44.979444, -93.276111);
            MyMap.ZoomLevel = 17;
        ...
        private void HyperlinkButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            LabeledMapLocation spaceNeedleLML = new LabeledMapLocation("Target Center", null);
