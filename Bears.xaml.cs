...
{
    public partial class Bears : PhoneApplicationPage
    {
        public Bears()
        {
            InitializeComponent();
        ...
        {
            MyMap.Center = new GeoCoordinate(41.8625, -87.6167);
            MyMap.ZoomLevel = 17;
        ...
        private void HyperlinkButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            LabeledMapLocation spaceNeedleLML = new LabeledMapLocation("Soldier Field", null);
