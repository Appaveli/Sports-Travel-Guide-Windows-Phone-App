...
{
    public partial class Seahawks : PhoneApplicationPage
    {
        public Seahawks()
        {
            InitializeComponent();
        ...
        {
            MyMap.Center = new GeoCoordinate(47.5952, -122.3316);
            MyMap.ZoomLevel = 17;
        ...
        private void HyperlinkButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            LabeledMapLocation spaceNeedleLML = new LabeledMapLocation("CenturyLink Field", null);
