...
{
    public partial class Celtics : PhoneApplicationPage
    {
        public Celtics()
        {
            InitializeComponent();
        ...
        {
            MyMap.Center = new GeoCoordinate(42.3663, -71.0622);
            MyMap.ZoomLevel = 17;
        ...
        private void HyperlinkButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            LabeledMapLocation spaceNeedleLML = new LabeledMapLocation("TD Garden", null);
