...
{
    public partial class Mavs : PhoneApplicationPage
    {
        public Mavs()
        {
            InitializeComponent();
        ...
        {
            MyMap.Center = new GeoCoordinate(32.7906, -96.8103);
            MyMap.ZoomLevel = 17;
        ...
        private void HyperlinkButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            LabeledMapLocation spaceNeedleLML = new LabeledMapLocation("American Airlines Center", null);
