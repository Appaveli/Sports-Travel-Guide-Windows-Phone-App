...
{
    public partial class Broncos : PhoneApplicationPage
    {
        public Broncos()
        {
            InitializeComponent();
        ...
        {
            MyMap.Center = new GeoCoordinate(39.7439, -105.0200);
            MyMap.ZoomLevel = 17;
        ...
        private void HyperlinkButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            LabeledMapLocation spaceNeedleLML = new LabeledMapLocation("Sports Authority Field at Mile High", null);
