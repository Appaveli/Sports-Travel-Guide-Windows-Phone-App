...
{
    public partial class Clippers : PhoneApplicationPage
    {
        public Clippers()
        {
            InitializeComponent();
        ...
        {
            MyMap.Center = new GeoCoordinate(34.0431, -118.2672);
            MyMap.ZoomLevel = 17;
        ...
        private void HyperlinkButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            LabeledMapLocation spaceNeedleLML = new LabeledMapLocation("Staples Center", null);
