...
{
    public partial class Cowboys : PhoneApplicationPage
    {
        public Cowboys()
        {
            InitializeComponent();
        ...
        {
            MyMap.Center = new GeoCoordinate(32.7478, -97.0928);
            MyMap.ZoomLevel = 17;
        ...
        private void HyperlinkButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            LabeledMapLocation spaceNeedleLML = new LabeledMapLocation("AT&T Stadium", null);
