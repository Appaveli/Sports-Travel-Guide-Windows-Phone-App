...
{
    public partial class Titans : PhoneApplicationPage
    {
        public Titans()
        {
            InitializeComponent();
        ...
        {
            MyMap.Center = new GeoCoordinate(36.1664, -86.7714);
            MyMap.ZoomLevel = 17;
        ...
        private void HyperlinkButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            LabeledMapLocation spaceNeedleLML = new LabeledMapLocation("LP Field", null);
