...
{
    public partial class Pelicans : PhoneApplicationPage
    {
        public Pelicans()
        {
            InitializeComponent();
        ...
        {
            MyMap.Center = new GeoCoordinate(29.948889, -90.081944);
            MyMap.ZoomLevel = 17;
        ...
        private void HyperlinkButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            LabeledMapLocation spaceNeedleLML = new LabeledMapLocation("Smoothie King Center", null);
