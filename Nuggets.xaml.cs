...
{
    public partial class Nuggets : PhoneApplicationPage
    {
        public Nuggets()
        {
            InitializeComponent();
        ...
        {
            MyMap.Center = new GeoCoordinate(39.7486, -105.0075);
            MyMap.ZoomLevel = 17;
        ...
        private void HyperlinkButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            LabeledMapLocation spaceNeedleLML = new LabeledMapLocation("Pepsi Center", null);
