...
{
    public partial class Bills : PhoneApplicationPage
    {
        public Bills()
        {
            InitializeComponent();
        ...
        {
            MyMap.Center = new GeoCoordinate(42.7740, -78.7870);
            MyMap.ZoomLevel = 17;
        ...
        private void HyperlinkButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            LabeledMapLocation spaceNeedleLML = new LabeledMapLocation("Ralph Wilson Stadium", null);
