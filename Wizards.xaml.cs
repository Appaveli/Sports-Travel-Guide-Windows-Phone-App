...
{
    public partial class Wizards : PhoneApplicationPage
    {
        public Wizards()
        {
            InitializeComponent();
        ...
        {
            MyMap.Center = new GeoCoordinate(38.8981, -77.0208);
            MyMap.ZoomLevel = 17;
        ...
        private void HyperlinkButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            LabeledMapLocation spaceNeedleLML = new LabeledMapLocation("Verizon Center", null);
