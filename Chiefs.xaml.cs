...
{
    public partial class Chiefs : PhoneApplicationPage
    {
        public Chiefs()
        {
            InitializeComponent();
        ...
        {
            MyMap.Center = new GeoCoordinate(39.0489, -94.4839);
            MyMap.ZoomLevel = 17;
        ...
        private void HyperlinkButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            LabeledMapLocation spaceNeedleLML = new LabeledMapLocation("Arrowhead Stadium", null);
