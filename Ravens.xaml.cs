...
{
    public partial class Ravens : PhoneApplicationPage
    {
        public Ravens()
        {
            InitializeComponent();
        ...
        {
            MyMap.Center = new GeoCoordinate(39.2781, -76.6228);
            MyMap.ZoomLevel = 17;
        ...
        private void HyperlinkButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            LabeledMapLocation spaceNeedleLML = new LabeledMapLocation("M&T Bank Stadium", null);
