...
{
    public partial class Cardinals : PhoneApplicationPage
    {
        public Cardinals()
        {
            InitializeComponent();
        ...
        {
            MyMap.Center = new GeoCoordinate(33.5275, -112.2625);
            MyMap.ZoomLevel = 17;
        ...
        private void HyperlinkButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            LabeledMapLocation spaceNeedleLML = new LabeledMapLocation("University of Phoenix Stadium", null);
