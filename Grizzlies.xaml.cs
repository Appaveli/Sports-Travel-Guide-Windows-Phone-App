...
{
    public partial class Grizzlies : PhoneApplicationPage
    {
        public Grizzlies()
        {
            InitializeComponent();
        ...
        {
            MyMap.Center = new GeoCoordinate(35.138333, -90.050556);
            MyMap.ZoomLevel = 17;
        ...
        private void HyperlinkButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            LabeledMapLocation spaceNeedleLML = new LabeledMapLocation("FedExForum", null);
