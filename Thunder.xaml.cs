...
{
    public partial class Thunder : PhoneApplicationPage
    {
        public Thunder()
        {
            InitializeComponent();
        ...
        {
            MyMap.Center = new GeoCoordinate(35.4633, -97.5150);
            MyMap.ZoomLevel = 17;
        ...
        private void HyperlinkButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            LabeledMapLocation spaceNeedleLML = new LabeledMapLocation("Chesapeake Energy Arena", null);
