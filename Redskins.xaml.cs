...
{
    public partial class Redskins : PhoneApplicationPage
    {
        public Redskins()
        {
            InitializeComponent();
        ...
        {
            MyMap.Center = new GeoCoordinate(38.9078, -76.8644);
            MyMap.ZoomLevel = 17;
        ...
        private void HyperlinkButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            LabeledMapLocation spaceNeedleLML = new LabeledMapLocation("FedExField", null);
