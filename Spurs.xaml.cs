...
{
    public partial class Spurs : PhoneApplicationPage
    {
        public Spurs()
        {
            InitializeComponent();
        ...
        {
            MyMap.Center = new GeoCoordinate(29.426944, -98.4375);
            MyMap.ZoomLevel = 17;
        ...
        private void HyperlinkButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            LabeledMapLocation spaceNeedleLML = new LabeledMapLocation("AT&T Center", null);
