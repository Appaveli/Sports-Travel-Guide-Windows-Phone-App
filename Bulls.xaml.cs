...
{
    public partial class Bulls : PhoneApplicationPage
    {
        public Bulls()
        {
            InitializeComponent();
        ...
        {
            MyMap.Center = new GeoCoordinate(41.880556, -87.674167);
            MyMap.ZoomLevel = 17;
        ...
        private void HyperlinkButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            LabeledMapLocation spaceNeedleLML = new LabeledMapLocation("United Center", null);
