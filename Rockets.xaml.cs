...
{
    public partial class Rockets : PhoneApplicationPage
    {
        public Rockets()
        {
            InitializeComponent();
        ...
        {
            MyMap.Center = new GeoCoordinate(29.7508, -95.3622);
            MyMap.ZoomLevel = 17;
        ...
        private void HyperlinkButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            LabeledMapLocation spaceNeedleLML = new LabeledMapLocation("Toyota Center", null);
