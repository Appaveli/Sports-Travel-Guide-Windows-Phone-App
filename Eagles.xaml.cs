...
{
    public partial class Eagles : PhoneApplicationPage
    {
        public Eagles()
        {
            InitializeComponent();
        ...
        {
            MyMap.Center = new GeoCoordinate(39.9008, -75.1675);
            MyMap.ZoomLevel = 17;
        ...
        private void HyperlinkButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            LabeledMapLocation spaceNeedleLML = new LabeledMapLocation("Lincoln Financial Field", null);
