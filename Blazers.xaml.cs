...
{
    public partial class Blazers : PhoneApplicationPage
    {
        public Blazers()
        {
            InitializeComponent();
        ...
        {
            MyMap.Center = new GeoCoordinate(45.531667, -122.666667);
            MyMap.ZoomLevel = 17;
        ...
        private void HyperlinkButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            LabeledMapLocation spaceNeedleLML = new LabeledMapLocation("Moda Center", null);
