...
{
    public partial class Vikings : PhoneApplicationPage
    {
        public Vikings()
        {
            InitializeComponent();
        ...
        {
            MyMap.Center = new GeoCoordinate(44.9739, -93.2581);
            MyMap.ZoomLevel = 17;
        ...
        private void HyperlinkButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            LabeledMapLocation spaceNeedleLML = new LabeledMapLocation("TCF Bank Stadium", null);
