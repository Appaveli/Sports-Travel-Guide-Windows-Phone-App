...
{
    public partial class Sixers : PhoneApplicationPage
    {
        public Sixers()
        {
            InitializeComponent();
        ...
        {
            MyMap.Center = new GeoCoordinate(39.901111, -75.171944);
            MyMap.ZoomLevel = 17;
        ...
        private void HyperlinkButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            LabeledMapLocation spaceNeedleLML = new LabeledMapLocation("Wells Fargo Center", null);
