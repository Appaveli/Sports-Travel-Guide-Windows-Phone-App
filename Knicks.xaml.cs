...
{
    public partial class Knicks : PhoneApplicationPage
    {
        public Knicks()
        {
            InitializeComponent();
        ...
        {
            MyMap.Center = new GeoCoordinate(40.7506, -73.9936);
            MyMap.ZoomLevel = 17;
        ...
        private void HyperlinkButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            LabeledMapLocation spaceNeedleLML = new LabeledMapLocation("Madison Square Garden", null);
